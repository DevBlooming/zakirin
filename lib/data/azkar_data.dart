...
final List<Map<String, dynamic>>? prayAzkar = zakirinData[6]['prayAzkar'];
final List<Map<String, dynamic>>? afterPrayAzkar =
    zakirinData[7]['afterPrayAzkar'];
final List<Map<String, dynamic>>? mosqueAzkar = zakirinData[8]['mosqueAzkar'];
final List<Map<String, dynamic>>? homeAzkar = zakirinData[9]['homeAzkar'];
final List<Map<String, dynamic>>? foodAzkar = zakirinData[10]['foodAzkar'];
final List<Map<String, dynamic>>? bathAzkar = zakirinData[11]['bathAzkar'];
