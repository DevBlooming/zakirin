...
قُلْ هُوَ ٱللَّهُ أَحَدٌ ﴿١﴾ ٱللَّهُ ٱلصَّمَدُ ﴿٢﴾ لَمْ يَلِدْ وَلَمْ يُولَدْ ﴿٣﴾ وَلَمْ يَكُن لَّهُۥ كُفُوًا أَحَدٌۢ ﴿٤﴾ [الإخلاص: ١-٤]
        """,
    count: 3,
    reward: """""",
  ),
...
قُلْ أَعُوذُ بِرَبِّ ٱلْفَلَقِ ﴿١﴾ مِن شَرِّ مَا خَلَقَ ﴿٢﴾ وَمِن شَرِّ غَاسِقٍ إِذَا وَقَبَ ﴿٣﴾ وَمِن شَرِّ ٱلنَّفَّـٰثَـٰتِ فِى ٱلْعُقَدِ ﴿٤﴾ وَمِن شَرِّ حَاسِدٍ إِذَا حَسَدَ ﴿٥﴾ [الفلق: ١-٥]
        """,
    count: 3,
    reward: """""",
  ),
...
قُلْ أَعُوذُ بِرَبِّ ٱلنَّاسِ ﴿١﴾ مَلِكِ ٱلنَّاسِ ﴿٢﴾ إِلَـٰهِ ٱلنَّاسِ ﴿٣﴾ مِن شَرِّ ٱلْوَسْوَاسِ ٱلْخَنَّاسِ ﴿٤﴾ ٱلَّذِى يُوَسْوِسُ فِى صُدُورِ ٱلنَّاسِ ﴿٥﴾ مِنَ ٱلْجِنَّةِ وَٱلنَّاسِ﴿ ٦﴾ [الناس: ١-٦]
""",
    count: 3,
    reward: """""",
  ),
...
const List<ZikrModel> nightAzkar = [
  ZikrModel(
    id: 0,
    content: """أَعُوذُ بِاللهِ مِنْ الشَّيْطَانِ الرَّجِيمِ
...
آمَنَ الرَّسولُ بِما أُنزِلَ إِلَيهِ مِن رَبِّهِ وَالمُؤمِنونَ كُلٌّ آمَنَ بِاللَّهِ وَمَلائِكَتِهِ وَكُتُبِهِ وَرُسُلِهِ لا نُفَرِّقُ بَينَ أَحَدٍ مِن رُسُلِهِ وَقالوا سَمِعنا وَأَطَعنا غُفرانَكَ رَبَّنا وَإِلَيكَ المَصيرُُ ﴿٢٨٥﴾ لَا يُكَلِّفُ اللَّهُ نَفسًا إِلّا وُسعَها لَها ما كَسَبَت وَعَلَيها مَا اكتَسَبَت رَبَّنا لا تُؤاخِذنا إِن نَسينا أَو أَخطَأنا رَبَّنا وَلا تَحمِل عَلَينا إِصرًا كَما حَمَلتَهُ عَلَى الَّذينَ مِن قَبلِنا رَبَّنا وَلا تُحَمِّلنا ما لا طاقَةَ لَنا بِهِ وَاعفُ عَنّا وَاغفِر لَنا وَارحَمنا أَنتَ مَولانا فَانصُرنا عَلَى القَومِ الكافِرينَ ﴿٢٨٦﴾ [البقرة: ٢٨٥-٢٨٦]""",
    count: 1,
    reward: """""",
  ),
  ZikrModel(
...
const List<ZikrModel> wakingUpAzkar = [
  ZikrModel(
    id: 0,
    content:
...
const List<ZikrModel> sleepAzkar = [
  ZikrModel(
    id: 0,
    content:
...
""",
  ...
  ZikrModel(
    id: 12,
    content: """ أَعُوذُ بِاللهِ مِنْ الشَّيْطَانِ الرَّجِيم
        
ٱللَّهُ لَآ إِلَـٰهَ إِلَّا هُوَ ٱلْحَىُّ ٱلْقَيُّومُ ۚ لَا تَأْخُذُهُۥ سِنَةٌۭ وَلَا نَوْمٌۭ ۚ لَّهُۥ مَا فِى ٱلسَّمَـٰوَٰتِ وَمَا فِى ٱلْأَرْضِ ۗ مَن ذَا ٱلَّذِى يَشْفَعُ عِندَهُۥٓ إِلَّا بِإِذْنِهِۦ ۚ يَعْلَمُ مَا بَيْنَ أَيْدِيهِمْ وَمَا خَلْفَهُمْ ۖ وَلَا يُحِيطُونَ بِشَىْءٍۢ مِّنْ عِلْمِهِۦٓ إِلَّا بِمَا شَآءَ ۚ وَسِعَ كُرْسِيُّهُ ٱلسَّمَـٰوَٰتِ وَٱلْأَرْضَ ۖ وَلَا يَـُٔودُهُۥ حِفْظُهُمَا ۚ وَهُوَ ٱلْعَلِىُّ ٱلْعَظِيمُ ﴿٢٥٥﴾ [البقرة: ٢٥٥]
""",
    count: 1,
    reward: """""",
  ),
...
const List<ZikrModel> azanAzkar = [
  ZikrModel(
    id: 0,
...
const List<ZikrModel> ablutionAzkar = [
  ZikrModel(
    id: 0,
...
const List<ZikrModel> prayAzkar = [
  ZikrModel(
    id: 0,
    content: """أدعية استفتاح الصلاة
...
اللهُ أكْبَرُ كَبِيْرًا، وَالْحَمْدُ لِلهِ كَثِيْرًا، وَسُبْحَانَ اللهِ بُكْرَةً وَّاصِيْلًا.
...
اللَّهُمَّ لَكَ الْحَمْدُ مِلْءَ السَّمَاءِ، وَمِلْءَ الْارْضِ، وَمِلْءَ مَا شِئْتَ مِنْ شَيْءٍ بَعْدُ، اللَّهُمَّ طَهِّرْنِي بِالثَّلْجِ وَالْبَرَدِ، وَالْمَاءِ الْبَارِدِ، اللَّهُمَّ طَهِّرْنِي مِنَ الذُّنُوبِ وَالْخَطَايَا، كَمَا يُنَقَّى الثَّوْبُ الْابْيَضُ مِنَ الدَّنَسِِ.
""",
    count: 1,
    reward: """""",
  ),
...
اللَّهُمَّ اجْعَلْ فِي قَلْبِي نُورًا وَاجْعَلْ فِيْ سَمْعِيْ نُورًا وَاجْعَلْ فِيْ بَصَرِيْ نُورًا وَاجْعَلْ مِنْ تَحْتِي نُورًا وَاجْعَلْ مِنْ فَوْقِي نُورًا وَعَنْ يَمِينِي نُورًا وَعَنْ يَسَارِي نُورًا وَاجْعَلْ أمَامِي نُورًا وَاجْعَلْ خَلْفِي نُورًا وَأعْظِمْ لِيْ نُورًا.""",
  ...
  ZikrModel(
    id: 4,
    content: """أدعية الجلوس بين السجدتين
...
التَّحِيَّاتُ لِلَّهِ وَالصَّلَوَاتُ وَالطَّيِّبَاتُ السَّلَامُ عَلَيْكَ أَيُّهَا النَّبِيُّ وَرَحْمَةُ اللَّهِ وَبَرَكَاتُهُ السَّلَامُ عَلَيْنَا وَعَلَى عِبَادِ اللَّهِ الصَّالِحِينَ ، أَشْهَدُ أَنْ لَا إِلَهَ إِلَّا اللَّهُ وَأَشْهَدُ أَنَّ مُحَمَّدًا عَبْدُهُ وَرَسُولُهُ. اللَّهُمَّ صَلِّ عَلَى مُحَمَّدٍ وَعَلَى آلِ مُحَمَّدٍ كَمَا صَلَّيْتَ عَلَى إِبْرَاهِيمَ وَعَلَى آلِ إِبْرَاهِيمَ إِنَّكَ حَمِيدٌ مَجِيدٌ ، اللَّهُمَّ بَارِكْ عَلَى مُحَمَّدٍ وَعَلَى آلِ مُحَمَّدٍ كَمَا بَارَكْتَ عَلَى إِبْرَاهِيمَ وَعَلَى آلِ إِبْرَاهِيمَ إِنَّكَ حَمِيدٌ مَجِيدٌ.""",
  ...
  ZikrModel(
    id: 8,
    content: """أدعية بعد التشهد الأخير وقبل السلام
...
const List<ZikrModel> afterPrayAzkar = [
  ZikrModel(
    id: 0,
...
ٱللَّهُ لَآ إِلَـٰهَ إِلَّا هُوَ ٱلْحَىُّ ٱلْقَيُّومُ ۚ لَا تَأْخُذُهُۥ سِنَةٌۭ وَلَا نَوْمٌۭ ۚ لَّهُۥ مَا فِى ٱلسَّمَـٰوَٰتِ وَمَا فِى ٱلْأَرْضِ ۗ مَن ذَا ٱلَّذِى يَشْفَعُ عِندَهُۥٓ إِلَّا بِإِذْنِهِۦ ۚ يَعْلَمُ مَا بَيْنَ أَيْدِيهِمْ وَمَا خَلْفَهُمْ ۖ وَلَا يُحِيطُونَ بِشَىْءٍۢ مِّنْ عِلْمِهِۦٓ إِلَّا بِمَا شَآءَ ۚ وَسِعَ كُرْسِيُّهُ ٱلسَّمَـٰوَٰتِ وَٱلْأَرْضَ ۖ وَلَا يَـُٔودُهُۥ حِفْظُهُمَا ۚ وَهُوَ ٱلْعَلِىُّ ٱلْعَظِيمُ ﴿٢٥٥﴾ [آية الكرسى - البقرة: ٢٥٥]
""",
    count: 1,
    reward: """""",
  ),
...
const List<ZikrModel> mosqueAzkar = [
  ZikrModel(
    id: 0,
...
const List<ZikrModel> homeAzkar = [
  ZikrModel(
    id: 0,
    content: """أذكار الدخول إلى المنزل
...
بِسْـمِ اللهِ وَلَجْنـا، وَبِسْـمِ اللهِ خَـرَجْنـا، وَعَلـى رَبِّنـا تَوَكّلْـنا.""",
  ...
  ZikrModel(
    id: 1,
    content: """أذكار الخروج من المنزل
...
const List<ZikrModel> foodAzkar = [
  ZikrModel(
    id: 0,
    content: """الذكر عند الطعام والشراب
...
اَللَّهُمَّ بَارِكْ لَنَا فِيهِ, وَزِدْنَا مِنْهُ.""",
  ...
  ZikrModel(
    id: 2,
    content: """الذكر عند الفراغ من الطعام والشراب
...
const List<ZikrModel> bathAzkar = [
  ZikrModel(
    id: 0,
    content: """الذكر عند الخلاء
...
(بِسْمِ الله) اللّهُـمَّ إِنِّـي أَعـوذُ بِـكَ مِـنَ الْخُـبْثِ وَالْخَبائِث.""",
  ...
  ZikrModel(
    id: 1,
    content: """الذكر بعد الخروج من الخلاء
...
final azkarCategories = [
  ...
  const CategoryModel(
    ...
    azkarListName: nightAzkar,
  ),
  const CategoryModel(
    id: 'c3',
    categoryName: 'أذكار الإستيقاظ',
    azkarListName: wakingUpAzkar,
  ),
  const CategoryModel(
    id: 'c4',
    categoryName: 'أذكار النوم',
    azkarListName: sleepAzkar,
  ),
  const CategoryModel(
    id: 'c5',
    categoryName: 'أذكار الآذان',
    azkarListName: azanAzkar,
  ),
  const CategoryModel(
    id: 'c6',
    categoryName: 'أذكار الوضوء',
    azkarListName: ablutionAzkar,
  ),
  const CategoryModel(
    id: 'c7',
    categoryName: 'أذكار الصلاة',
    azkarListName: prayAzkar,
  ),
  const CategoryModel(
    id: 'c8',
    categoryName: 'أذكار بعد الصلاة',
    azkarListName: afterPrayAzkar,
  ),
  const CategoryModel(
    id: 'c9',
    categoryName: 'أذكار المسجد',
    azkarListName: mosqueAzkar,
  ),
  const CategoryModel(
    id: 'c10',
    categoryName: 'أذكار المنزل',
    azkarListName: homeAzkar,
  ),
  const CategoryModel(
    id: 'c11',
    categoryName: 'أذكار الطعام',
    azkarListName: foodAzkar,
  ),
  const CategoryModel(
    id: 'c12',
    categoryName: 'أذكار الخلاء',
    azkarListName: bathAzkar,
  ),
];
